            ...
            <div className="mt-32 grid grid-cols-2 gap-8">
                    <div>
                        ...
                        <div className="docCentral flex flex-col items-center mt-12">
                            <Image src="/img/internship/chatcentral.jpg" width={600} height={900} alt="QA Bot" />
                            <p className='mt-2 font-medium'>GPT-powered QA Bot in practice.</p>
                        </div>
                        <div className="docCentral flex flex-col items-center mt-12">
                            <Image src="/img/internship/guide.gif" width={600} height={900} alt="docCentral guide intro" />
                    ...
                    <div>
                        ...
                        <h1 className="text-4xl col-span-2 lg:col-start-2 text-right mt-32"><span className="text-qaPurple">GPT-powered QA Bot</span></h1>
                        <p className="text-xl col-span-2 lg:col-start-2 text-justify">
                            docCental is a document templating plugin for Microsoft Word that enables government officers to create documents from templates in a seamless and time-saving method.
                            docCental is a document templating plugin for Microsoft Word that enables government officers to create documents from templates in a seamless and time-saving method.
                            docCental is a document templating plugin for Microsoft Word that enables government officers to create documents from templates in a seamless and time-saving method.
                            docCental is a document templating plugin for Microsoft Word that enables government officers to create documents from templates in a seamless and time-saving method.
                            docCental is a document templating plugin for Microsoft Word that enables government officers to create documents from templates in a seamless and time-saving method.
                        ...
                        <h1 className="text-4xl col-span-2 lg:col-start-2 text-right mt-32"><span className="text-dcYellow">docCentral</span></h1>
                        <p className="text-xl col-span-2 lg:col-start-2 text-justify">
                            docCental is a document templating plugin for Microsoft Word that enables government officers to create documents from templates in a seamless and time-saving method.
                        </p>
                    </div>
